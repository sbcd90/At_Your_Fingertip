...
class SearchResult(webapp.RequestHandler):
	def post(self):
		...
		url="https://maps.googleapis.com/maps/api/place/textsearch/json?query="+search_string+"&sensor=true&key=AIzaSyClgIulgEkpcsb00hsvoHWFjvIoIg7tMp8"
